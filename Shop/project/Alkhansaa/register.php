...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="password" name="password" required placeholder=" pasword" class="box">
      <input type="password" name="cpassword" required placeholde=" pasword Again" class="box">
